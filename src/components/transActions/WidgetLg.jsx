...
export default function WidgetLg(){
    ...
    return(
        ...
        <ul className=' w-full mt-3  '>
         <table className=' w-full flex flex-col gap-y-3'>
           ...
           {transactions.map(transaction =>{
            ...
            : 'text-green-600' ;
            return(
                <tr className='grid grid-cols-5 bg-white p-2.5 rounded-sm shadow-md items-center'>
                ...
                <td className='text-gray-400 text-center'>{transaction.date}</td>
                 ...
                 <button type='' className={`bg-gray-200/60 p-px text-center cursor-pointer ${statusClass}`}>{transaction.status}</button>
                </tr>
            )
           })}
